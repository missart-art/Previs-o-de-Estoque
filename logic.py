...
def get_tipo_dia(dt):
    ...
    ou 'util'.
    """
    # Verifica se a data está na lista de feriados do config.py[cite: 5]
...
def simular_duracao(nome_produto, estoque_atual):
    """
    Simula o gasto diário futuro para prever a data de esgotamento[cite: 7].
    """
    if estoque_atual <= 0: 
        return 0, "Esgotado"
    ...
    # Se não houver dados históricos, não há como prever[cite: 7]
    ...
    # Loop de simulação: subtrai o gasto médio dia após dia[cite: 7]
